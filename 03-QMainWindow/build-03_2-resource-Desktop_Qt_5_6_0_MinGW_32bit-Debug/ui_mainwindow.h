...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionW1 = new QAction(MainWindow);
        actionW1->setObjectName(QStringLiteral("actionW1"));
        ...
        menuFile->addSeparator();
        menuFile->addAction(actionW1);
        mainToolBar->addAction(actionNew);
        mainToolBar->addAction(actionOpen);
        mainToolBar->addAction(actionW1);
...
#endif // QT_NO_TOOLTIP
        actionW1->setText(QApplication::translate("MainWindow", "\346\265\213\350\257\225", 0));
